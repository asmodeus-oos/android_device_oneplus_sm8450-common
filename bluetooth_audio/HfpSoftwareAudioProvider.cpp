...
HfpSoftwareOutputAudioProvider::HfpSoftwareOutputAudioProvider() : HfpSoftwareAudioProvider() {
    session_type_ = SessionType::HFP_SOFTWARE_ENCODING_DATAPATH;
}

HfpSoftwareInputAudioProvider::HfpSoftwareInputAudioProvider() : HfpSoftwareAudioProvider() {
...
ndk::ScopedAStatus HfpSoftwareAudioProvider::startSession(
    ...
    const PcmConfiguration& pcm_config = audio_config.get<AudioConfiguration::pcmConfig>();
    ...
    uint32_t data_mq_size = kBufferCount * bytes_per_sample * (pcm_config.sampleRateHz / 1000) *
...
ndk::ScopedAStatus HfpSoftwareAudioProvider::onSessionReady(DataMQDesc* _aidl_return) {
